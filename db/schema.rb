...
ActiveRecord::Schema.define(:version => 20130129061525) do
  ...
  add_index "accountings", ["email"], :name => "index_accountings_on_email", :unique => true
  add_index "accountings", ["reset_password_token"], :name => "index_accountings_on_reset_password_token", :unique => true
